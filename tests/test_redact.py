...
def test_distribution_metadata_registration_and_remote_dependency():
    ...
    assert project["dependencies"][0]==f"convos>={project['version']},<0.12" and project["entry-points"]["convos.commands"]=={"redact":"ai_convos_redact:register"} and project["entry-points"]["convos.doctor"]=={"redact":"ai_convos_redact:doctor_status"}
    assert f"convos-redact>={project['version']},<0.12" in remote["dependencies"] and core["optional-dependencies"]["redact"]==[f"convos-redact>={project['version']},<0.12"]
