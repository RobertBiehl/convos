...
def test_distribution_metadata_registration_and_help():
    ...
    assert project["dependencies"][:2]==["convos>=0.11.6b12,<0.12","convos-redact>=0.11.6b12,<0.12"] and project["entry-points"]["convos.commands"]=={"resume":"ai_convos_resume:register"} and "resume" not in core["optional-dependencies"]
