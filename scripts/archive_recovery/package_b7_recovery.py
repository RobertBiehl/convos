...
FILES = [
    ...
    "docs/database-connection-ledger.md", "docs/b7-archive-recovery.md", "docs/b7-minimal-fixture.md", "docs/archive-hardening.md", "scripts/archive_recovery/README.md",
    "scripts/archive_recovery/repair_b7_archive.py", "scripts/archive_recovery/verify_b7_recovery.py", "scripts/archive_recovery/verify_b7_attestation.py", "scripts/archive_recovery/package_b7_recovery.py", "scripts/archive_recovery/diagnose_b7_rows.py",
    ...
    "scripts/archive_recovery/b7_minimal_fixture.py", "tests/test_minimal_b7_fixture.py", "tests/test_recovery_integrity.py", "tests/test_doctor_relationships.py", "tests/test_remote_operations.py",
]
INVENTORY_FIELDS = {
...
def main() -> None:
    ...
    parser.add_argument("--base", default="v0.11.6b8")
    ...
    if args.diagnostics:
        entries["scripts/archive_recovery/convos-b7-diagnostics.py"] = args.diagnostics.read_bytes()
